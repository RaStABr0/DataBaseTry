...
public class RegisterActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        passwordViewAgain = findViewById(R.id.passwordAgain);
        ...
        registerButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(email)){
                    Toast.makeText(RegisterActivity.this, "E-mail field is empty", Toast.LENGTH_LONG).show();
                    return;
                }

                String password1 = passwordView.getText().toString();
                String password2 = passwordViewAgain.getText().toString();
                ...
                mAuth.createUserWithEmailAndPassword(email, password1).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(!task.isSuccessful()) {
                            Toast.makeText(RegisterActivity.this, "Something goes wrong!", Toast.LENGTH_LONG).show();
    ...
    private boolean checkPasswords(String password1, String password2){
        ...
        if(TextUtils.equals(password1, password2))
            ...
            Toast.makeText(RegisterActivity.this, "Passwords you entered are different!", Toast.LENGTH_LONG).show();
            return false;
